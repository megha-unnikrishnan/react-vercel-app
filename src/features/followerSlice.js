...
export const followUser = createAsyncThunk(
  ...
  async (followedId, { rejectWithValue }) => {
    try {
      const response = await fetch(`https://talkstream.xyz/api/follow/${followedId}/`, {
        method: 'POST',
        headers: {
...
export const unfollowUser = createAsyncThunk(
  ...
  async (followedId, { rejectWithValue }) => {
    try {
      const response = await fetch(`https://talkstream.xyz/api/unfollow/${followedId}/`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${localStorage.getItem('token')}`,
...
export const fetchFollowingandfollowers = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.get('https://talkstream.xyz/api/userdetail/', {
        headers: {
...
export const fetchFollowing = createAsyncThunk(
  ...
  async (userId, { rejectWithValue }) => {
    try {
      const response = await fetch(`https://talkstream.xyz/api/following/${userId}/`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${localStorage.getItem('token')}`,
...
export const fetchFollowers = createAsyncThunk(
  ...
  async (userId, { rejectWithValue }) => {
    try {
      const response = await fetch(`https://talkstream.xyz/api/followers/${userId}/`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${localStorage.getItem('token')}`,
